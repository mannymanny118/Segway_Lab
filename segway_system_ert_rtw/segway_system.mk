###########################################################################
## Makefile generated for Simulink model 'segway_system'. 
## 
## Makefile     : segway_system.mk
## Generated on : Thu Nov 19 09:22:52 2020
##  version:  
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/segway_system.elf
...
PRODUCT_NAME              = segway_system
MAKEFILE                  = segway_system.mk
MATLAB_ROOT               = C:/PROGRA~1/MATLAB/R2020a
MATLAB_BIN                = C:/PROGRA~1/MATLAB/R2020a/bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)/win64
MASTER_ANCHOR_DIR         = 
START_DIR                 = C:/Users/super/Documents/Mechatronics/Segway_Lab
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
...
SLIB_PATH        = C:/Users/super/DOCUME~1/MATLAB/R2020a/ARDUIN~1/ARDUIN~1/FASTER~2
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/segway_system.elf
...
INCLUDES_BUILDINFO = -I$(START_DIR) -IC:/Users/super/DOCUME~1/MATLAB/RASPlib/src -IC:/Users/super/DOCUME~1/MATLAB/RASPlib/include -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2020a/3P778C~1.INS/ARDUIN~1.INS/hardware/arduino/avr/LIBRAR~1/Wire -IC:/ProgramData/MATLAB/SupportPackages/R2020a/3P.instrset/arduinoide.instrset/hardware/arduino/avr/libraries/Wire/utility -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2020a/3P778C~1.INS/ARDUIN~1.INS/hardware/arduino/avr/LIBRAR~1/Wire/src -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2020a/3P778C~1.INS/ARDUIN~1.INS/hardware/arduino/avr/LIBRAR~1/Wire/src/utility -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2020a/toolbox/target/shared/svd/include -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2020a/toolbox/target/SUPPOR~1/ARDUIN~2/include -I$(START_DIR)/segway_system_ert_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert -I$(MATLAB_ROOT)/toolbox/coder/rtiostream/src -I$(MATLAB_ROOT)/toolbox/coder/rtiostream/src/utils -I$(ARDUINO_ROOT)/hardware/arduino/avr/cores/arduino -I$(ARDUINO_ROOT)/hardware/arduino/avr/variants/mega -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2020a/toolbox/target/SUPPOR~1/ARDUIN~1/include -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2020a/toolbox/target/SUPPOR~1/ARDUIN~1/SCHEDU~1/include -I$(ARDUINO_ROOT)/hardware/tools/avr/avr/include/avr -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2020a/toolbox/target/shared/EXTERN~1/include
...
DEFINES_STANDARD = -DMODEL=segway_system -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = encoder_arduino.o Wire.o twi.o I2Cdev.o MPU6050.o MPU6050wrapper.o MW_PWM.o MW_PWMDriver.o ArduinoPinHandleMap.o MW_arduino_digitalio.o rtGetInf.o rtGetNaN.o rt_nonfinite.o segway_system.o segway_system_data.o updown.o ext_work.o rtiostream_utils.o MW_ArduinoHWInit.o io_wrappers.o arduinoAVRScheduler.o rtiostream_interface.o ext_svr_daemon.o rtiostream_serial_daemon.o daemon_checksum.o
...
%.o : C:/Users/super/Documents/MATLAB/RASPlib/src/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.S.o : C:/Users/super/Documents/MATLAB/RASPlib/src/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : C:/Users/super/Documents/MATLAB/RASPlib/src/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/segway_system_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.S.o : $(START_DIR)/segway_system_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/segway_system_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
encoder_arduino.o : C:/Users/super/Documents/MATLAB/RASPlib/blocks/../src/encoder_arduino.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
ert_main.o : $(START_DIR)/segway_system_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetInf.o : $(START_DIR)/segway_system_ert_rtw/rtGetInf.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetNaN.o : $(START_DIR)/segway_system_ert_rtw/rtGetNaN.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rt_nonfinite.o : $(START_DIR)/segway_system_ert_rtw/rt_nonfinite.c
	$(CC) $(CFLAGS) -o "$@" "$<"


segway_system.o : $(START_DIR)/segway_system_ert_rtw/segway_system.c
	$(CC) $(CFLAGS) -o "$@" "$<"


segway_system_data.o : $(START_DIR)/segway_system_ert_rtw/segway_system_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"
